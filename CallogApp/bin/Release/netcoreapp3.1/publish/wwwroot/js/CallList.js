    ...
    dataTable = $('#DT_load').DataTable({
        ...
        "columns": [
            ...
            { "data": "createDate", "width": "20%" },
            {
             ...
             <a href="/Admin/Calls/Edit/${data}" class='btn btn-success text-white style='cursor:pointer; width:70px;'>Edit</a>
            &nbsp<a class='btn btn-danger text-white style='cursor:pointer; width:70px;' onclick=Delete('/api/call?id='+${data})>Delete</a></div>`;
                }, "width": "40%"
            }
