    ...
    dataTable = $('#DT_load').DataTable({
        ...
        "columns": [
...

            {
             ...
             <a href="/User/Approvallevel3/Edit/${data}" class='style='cursor:pointer;'><i class='fa fa-edit text-success'></i>Edit</a>
            &nbsp<a class='btn text-danger style='cursor:pointer;' onclick=Delete('/api/approvallevel3?id='+${data})><i class='fa fa-trash text-danger'></i>Delete</a></div>`;
                }, "width": "40%"
            }
