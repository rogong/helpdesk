...
namespace CallogApp.Areas.Admin.Controllers
{
    ...
    public class ITStaffsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Specialisation")] ITStaff iTStaff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Specialisation")] ITStaff iTStaff)
        {
            if (id != iTStaff.Id)
            {
                return NotFound();
